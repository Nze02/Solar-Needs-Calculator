...
function calculatePanel(){
    ...
    let _name = panelOptions[userChoice].text;
    let x = [power, _name];
...
function calculateSolar(){
    ...
    let feedback = "";
    feedback += "<p>Based on your average daily use of "+ Math.round(dailyUseKw) +" kWh, you will need to purchase "+ panelsNeeded + " " + panelName +" solar panels to offset 100% 0f your electricity bill.</p>";
